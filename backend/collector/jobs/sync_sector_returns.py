...
from backend.collector.repositories.base import fetch_frame, get_latest_date, upsert_frame
from backend.collector.repositories.sync_state_repo import upsert_job_state
from backend.collector.sources.sector_returns import build_sector_returns
from backend.collector.utils.logging import log


def run(default_lookback_days: int) -> dict:
    """price_data? stock_info瑜??댁슜???뱁꽣 ?섏씡瑜좎쓣 怨꾩궛?쒕떎."""
