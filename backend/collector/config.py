...
from backend.collector.universe import get_default_universe_file
...
def get_settings() -> CollectorSettings:
    return CollectorSettings(
        ...
        macro_backfill_start=os.environ.get("LENS_MACRO_BACKFILL_START_DATE", "2015-01-01"),
        price_lookback_days=int(os.environ.get("LENS_PRICE_LOOKBACK_DAYS", "7")),
        ...
        indicator_lookback_days=int(os.environ.get("LENS_INDICATOR_LOOKBACK_DAYS", "14")),
        indicator_backfill_batch_size=int(os.environ.get("LENS_INDICATOR_BACKFILL_BATCH_SIZE", "25")),
