...
CP225 분리 산출. RSI/MACD/볼린저/ATR/MA비율 등 지표 계산, regime/context flag,
fundamental merge_asof, build_features / build_price_features 오케스트레이션.
의존: feature_definition (상수), validators (OHLC contract / ratio sanity),
resampling (timeframe / resample).
"""
