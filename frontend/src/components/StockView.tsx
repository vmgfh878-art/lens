...
import { BAND_STALE_THRESHOLD_BUSINESS_DAYS } from "@/lib/constants";
import { isValidDate, sortUniqueByDate, uniqueDates } from "@/lib/dateUtils";
import {
  formatNumber,
  formatPercent,
  formatRatio,
...
// 순수 헬퍼 (getLastPrice / getChangePercent / getLastFinite / buildAiState /
// fetchPriceHistory)는 @/lib/stock/helpers 로 이동했다.
